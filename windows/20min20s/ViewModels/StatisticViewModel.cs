...
namespace ProjectEye.ViewModels
{
    public class StatisticViewModel
    {
        ...
        {
            string worktimeimgpath = string.IsNullOrEmpty(config.options.Style.DataWindowWorkTimeImagePath) ? "pack://application:,,,/20min20s;component/Resources/web_developer.png" : config.options.Style.DataWindowWorkTimeImagePath;
            string resttimeimgpath = string.IsNullOrEmpty(config.options.Style.DataWindowRestTimeImagePath) ? "pack://application:,,,/20min20s;component/Resources/coffee_lover.png" : config.options.Style.DataWindowRestTimeImagePath;
            string skipimgpath = string.IsNullOrEmpty(config.options.Style.DataWindowSkipImagePath) ? "pack://application:,,,/20min20s;component/Resources/office_work_.png" : config.options.Style.DataWindowSkipImagePath;
        ...
        private void OnGenerateMonthlyDataImgCommand(object obj)
        {
            ...
            dlg.FileName = "20min20s " + Data.Year + Data.Month;
            dlg.DefaultExt = ".jpg";
            dlg.Filter = "(.jpg)|*.jpg";
        ...
        private void OnExportDataCommand(object obj)
        {
            ...
            {
                Microsoft.Win32.SaveFileDialog dlg = new Microsoft.Win32.SaveFileDialog();
                dlg.FileName = "20min20s statistic data " + Data.Year + Data.Month;
                dlg.DefaultExt = ".xlsx";
